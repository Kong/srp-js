...
describe('crypt', () => {
  ...
  describe('AES', () => {
    it('encrypts and decrypts', () => {
      ...
      const resultEncrypted = encryptAES(key, 'Hello World!', 'additional data');
      const resultDecrypted = decryptAES(key, resultEncrypted);
  ...
  describe('RSA', () => {
    it('encrypts and decrypts', () => {
      ...
      const resultEncrypted = encryptRSAWithJWK(publicKey, 'aaaaaaaaa');
      const resultDecrypted = decryptRSAWithJWK(privateKey, resultEncrypted);
