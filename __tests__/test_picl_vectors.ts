...
function checkVectors(params, inputs, expected) {
  hexequal(
    inputs.I,
    new Buffer("616e6472c3a9406578616d706c652e6f7267", "hex"),
    "I"
  );
  hexequal(
...
describe("picl vectors", () => {
  it("vectors 1", () => {
    checkVectors(params, inputs_1, expected_1);
  });

  it("vectors 2", () => {
    checkVectors(params, inputs_2, expected_2);
  });

  it("vectors 3", () => {
    checkVectors(params, inputs_3, expected_3);
  });

  it("vectors 4", () => {
    checkVectors(params, inputs_4, expected_4);
  });
});
